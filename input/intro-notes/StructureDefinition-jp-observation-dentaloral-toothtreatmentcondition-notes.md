...
* [**口腔診査結果1（現存歯の処置状態）**][jp-observation-dentaloral-toothtreatmentcondition-example-1]  
* [**口腔診査結果2（現存歯の処置状態）**][jp-observation-dentaloral-toothtreatmentcondition-example-2]
* [**口腔診査結果3（現存歯の処置状態）**][jp-observation-dentaloral-toothtreatmentcondition-example-3]
