...
JP Core は以下の方々、および各サーブワーキンググループのここに記載されていない多くのメンバの献身的な活動や協力により作成されている。<br>

- <a href="https://jpfhir.jp/">日本医療情報学会FHIR国内実装基盤研究会</a>

  - NeXEHRS 研究会代表幹事・FHIR 国内実装基盤研究会 座長　大江和彦（東京大学）
  - Infrastructure : インフラ基盤 WG
