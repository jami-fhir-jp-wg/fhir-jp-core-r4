...
Parent: {base-profile}
Id: jp-{profile}
Title: "JP Core {Profile} Profile"
Description: "このプロファイルは{Profile}リソースに対して、患者のデータを送受信するための基礎となる制約と拡張を定めたものである。"
* ^url = "http://jpfhir.jp/fhir/core/StructureDefinition/JP_{Profile}"
* ^status = #active
* ^date = "2022-10-24"
...
//   Extension 定義
// ==============================
Extension: JP_{Profile}_Race
Id: jp-{profile}-race
Title: "JP Core {Profile} Race Extension"
Description: "人種(Race)に関する情報を格納するためのExtension。"
* ^url = "http://jpfhir.jp/fhir/core/Extension/StructureDefinition/JP_{Profile}_Race"
* ^status = #active
* ^date = "2022-10-24"
* ^context.type = #element
* ^context.expression = "{Profile}"
* . ^short = "人種に関する情報"
...
- 2040-4 : Korean  
等"
* url = "http://jpfhir.jp/fhir/core/Extension/StructureDefinition/JP_{Profile}_Race" (exactly)
* value[x] only CodeableConcept
* valueCodeableConcept from ${Profile}-race-vs  (preferred)